...
public class SoundTestController {
    ...
    public void playSound1(){
        String musicFile = "src/assets/verbs/arbor.mp3";
    ...
    public void playSound2(){
        String musicFile = "src/assets/verbs/chibog.mp3";
    ...
    public void playSound3(){
        String musicFile = "src/assets/verbs/dugas.mp3";
    ...
    public void recognizeText1() {
        ...
        if (result != null) {
            ...
            if (resultText.equals("borrow") || resultText.equals("to borrow")){
                scenes.scores.Sector04Score = scenes.scores.Sector04Score + 1;
                ...
                scenes.scores.Sector04Scene = scenes.scores.Sector04Scene + 1;

                if (scenes.scores.Sector04Scene > 9) {
                    scenes.scores.Sector04Clear = true;
                    scenes.scores.Sector04Scene = scenes.scores.Sector04Scene - 1;
                }
    ...
    public void recognizeText2() {
        ...
        if (result != null) {
            ...
            if (resultText.equals("eat") || resultText.equals("to eat")){
                scenes.scores.Sector04Score = scenes.scores.Sector04Score + 1;
    ...
    public void recognizeText3() {
        ...
        if (result != null) {
            ...
            if (resultText.equals("swindle") || resultText.equals("to swindle") || resultText.equals("cheat") || resultText.equals("to cheat")){
                scenes.scores.Sector04Score = scenes.scores.Sector04Score + 1;
    ...
    public void getNext(MouseEvent mouseEvent) throws IOException {
        ...
        if(scenes.scores.Sector04Score >= 9){
            ...
            AnchorPane nextpane = FXMLLoader.load(getClass().getResource("Level"+scenes.scores.Sector04Scene+".fxml"));
            Pane11.getChildren().setAll(nextpane);
        }
    }
