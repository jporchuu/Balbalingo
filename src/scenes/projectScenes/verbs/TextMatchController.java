...
public class TextMatchController extends scenes.scores{
    ...
    public void matchText1(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("dugas")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void matchText2(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("balbal")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void matchText3(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("salisi")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void playSound2(){
        String musicFile = "src/assets/verbs/balbal.mp3";
    ...
    public void playSound3(){
        String musicFile = "src/assets/verbs/salisi.mp3";
