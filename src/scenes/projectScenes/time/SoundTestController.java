...
public class SoundTestController {
    ...
    public void playSound1(){
        String musicFile = "src/assets/time/0100.mp3";
    ...
    public void playSound2(){
        String musicFile = "src/assets/time/1200.mp3";
    ...
    public void recognizeText1() {
        ...
        if (result != null) {
            ...
            if (resultText.equals("one o'clock")){
                ...
                if (scenes.scores.Sector02Scene > 9) {
                    scenes.scores.Sector02Clear = true;
                    scenes.scores.Sector02Scene = scenes.scores.Sector02Scene - 1;
                }
            }
    ...
    public void recognizeText2() {
        ...
        if (result != null) {
            ...
            if (resultText.equals("twelve o'clock")){
                scenes.scores.Sector02Score = scenes.scores.Sector02Score + 1;
