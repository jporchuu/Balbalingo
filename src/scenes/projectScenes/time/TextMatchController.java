package scenes.projectScenes.time;
...
public class TextMatchController extends scenes.scores{
    ...
    public void matchText1(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("alas kwatro")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void matchText2(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("alas singko")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void matchText3(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("alas nwebe")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void playSound1(){
        String musicFile = "src/assets/time/0400.mp3";
    ...
    public void playSound2(){
        String musicFile = "src/assets/time/0500.mp3";
    ...
    public void playSound3(){
        String musicFile = "src/assets/time/0900.mp3";
    ...
    public void getRightChoice(){
        ...
        scenes.scores.Sector02Score = scenes.scores.Sector02Score + 1;
        ...
        scenes.scores.Sector02Scene = scenes.scores.Sector02Scene + 1;

        if (scenes.scores.Sector02Scene > 9) {
            scenes.scores.Sector02Scene = scenes.scores.Sector02Scene - 1;
        }
    }
    ...
    public void getNext(MouseEvent mouseEvent) throws IOException {
        AnchorPane nextpane = FXMLLoader.load(getClass().getResource("Level"+scenes.scores.Sector02Scene+".fxml"));
