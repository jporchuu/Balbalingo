...
public class TextMatchController extends scenes.scores{
    ...
    public void matchText1(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("noypi")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void matchText2(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("mars")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void matchText3(ActionEvent event){
        if(textAnswer.getText().toLowerCase().equals("bagets")){
            getRightChoice();
        }
        else{
            getWrongChoice();
    ...
    public void playSound2(){
        String musicFile = "src/assets/people/Mars.mp3";
    ...
    public void playSound3(){
        String musicFile = "src/assets/people/Bagets.mp3";
